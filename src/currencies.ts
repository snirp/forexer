// Compiled from https://gist.github.com/nhalstead/4c1652563dd13357ab936fc97703c019
...
export type Ccode = keyof typeof currencyMap;
...
export const currencyMap: CurrencyMap = currencies.reduce(
  (acc, { code, currency, symbol }) => ({
    ...acc,
